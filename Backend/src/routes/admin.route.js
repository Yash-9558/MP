...
router.post("/admin/logout", catchAsync(AdminController.logoutAdminHandler));

// router.post(
//   "/employee/logout",
//   catchAsync(adminAuth(roleTypes.LOGOUT_EMPLOYEE)),
//   catchAsync(AdminController.logoutEmployeeHandler)
// );
